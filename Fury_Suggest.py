...
print(BG_WHITE + WHITE)

print(CYAN)
print("                                                    1 ➤ WBC Analysis")
print("                                                    2 ➤ Lipid Profile")
print("                                                    3 ➤ Liver Function Test")
print("                                                    4 ➤ Kidney Function Test")
print("                                                    5 ➤ Thyroid Test")
print("                                                    6 ➤ Exit")
print(RESET)
